...
running command...
$ cli (--version)
cli/0.0.0 linux-x64 node-v16.20.0
$ cli --help [COMMAND]
USAGE
  $ cli COMMAND
...
...
_See code: [dist/commands/hello/index.ts](https://github.com/dao-private-voting2/cli/blob/v0.0.0/dist/commands/hello/index.ts)_
